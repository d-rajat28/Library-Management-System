...
//to fetch issue book details from database and display it to panel
    ...
    public void getIssuedBookDetails(){
        ...
        try {
            ...
            if(rs.next())
            {
                ...
                lbl_IssuseDate.setText(rs.getString("issue_date"));
    ...
    private void initComponents() {
        ...
        lbl_IssuseDate = new javax.swing.JLabel();
        ...
        lbl_IssuseDate.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        lbl_IssuseDate.setForeground(new java.awt.Color(255, 255, 255));
        jPanel3.add(lbl_IssuseDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 420, 220, 30));
        ...
        jPanel3.add(lbl_issueId, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 270, 220, 30));

        lbl_bookname.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        lbl_bookname.setForeground(new java.awt.Color(255, 255, 255));
        jPanel3.add(lbl_bookname, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 320, 220, 30));

        lbl_studentName.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        lbl_studentName.setForeground(new java.awt.Color(255, 255, 255));
        jPanel3.add(lbl_studentName, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 370, 220, 30));
        ...
        jPanel3.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 470, -1, -1));

        lbl_DueDate.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        lbl_DueDate.setForeground(new java.awt.Color(255, 255, 255));
        jPanel3.add(lbl_DueDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 470, 220, 30));

        panel_main.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 0, 390, 820));
        ...
        panel_main.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 110, -1, -1));
        ...
        panel_main.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 170, 290, 5));
        ...
        panel_main.add(txt_studentId, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 390, 220, -1));
        ...
        panel_main.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 390, 140, 30));
        ...
        panel_main.add(rSMaterialButtonCircle1, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 630, 280, 70));
        ...
        panel_main.add(rSMaterialButtonCircle2, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 530, 280, 70));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/library-768x513.jpg"))); // NOI18N
        panel_main.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, 370, 510));
        ...
        panel_main.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 50, 50));
    ...
    private javax.swing.JLabel lbl_IssuseDate;
